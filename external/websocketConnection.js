...
var WebsocketConnection = Class.extend({
  initialize: function(serverHost, serverPort, onOpenCallback, onMessageCallback) {
  ...
  onOpenHaxe: function(connection) {
    ...
    connection._onOpenCallback(connection);
  },
